...
import { FaUsers, FaLightbulb, FaHandshake, FaPhoneAlt, FaEnvelope } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-r from-blue-900 to-blue-900 text-white h-[70vh] flex flex-col justify-center items-center text-center px-6 overflow-hidden">
        ...
        >
          <a href="#apply" className="bg-yellow-500 text-blue-900 px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-yellow-400 transition">
            Apply Now
          </a>
          <a href="#contact" className="border-2 border-white px-6 py-3 rounded-lg hover:bg-white hover:text-blue-900 transition">
            Contact Us
          </a>
        </motion.div>
      </section>
      ...
      <section id="apply" className="relative bg-gradient-to-r from-purple-50 via-blue-50 to-teal-50 py-20 overflow-hidden">
...
<div>
  <label className="block mb-2 text-gray-700 font-medium">Cover Letter (Optional)</label>
  <textarea
  ...
  ></textarea>
          ...
          >
            <div className="bg-white rounded-3xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-transform transform hover:-translate-y-2 mt-0 md:mt-10">
              ...
              <p className="text-gray-600 text-sm text-center">Work with experienced professionals in a collaborative and innovative environment.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-transform transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 text-sm text-center">Get involved in exciting HR solutions and staffing innovations that make a difference.</p>
            </div>

            <div className="bg-white rounded-3xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-transform transform hover:-translate-y-2">
              <FaHandshake className="w-10 h-10 text-purple-600 mb-3" />
              <h3 className="font-semibold text-lg mb-2">Employee Benefits</h3>
              <p className="text-gray-600 text-sm text-center">Enjoy competitive compensation, growth opportunities, and a supportive work environment.</p>
            </div>
          </motion.div>
        </div>
      </section>
    ...
    <section className="relative bg-gradient-to-r from-blue-800 to-blue-900 text-white py-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        <motion.p
          ...
          transition={{ delay: 0.2, duration: 0.8 }}
        >
          Have questions or want to know more about our HR solutions? Connect with us directly!
        </motion.p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-black text-sm">+91 99903 16499</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-black text-sm">info@baryahr.com</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-black text-sm">123 Business St, Delhi, India</p>
          </motion.div>
        </div>
